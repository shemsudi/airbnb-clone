...
import { RootState, useAppDispatch, useAppSelector } from "../redux/store.js";

//reduxstate
import { closeLoginPage } from "../redux/ModalReducer.js";
  ...
  return (
    <ModalWrapper onClose={handleCloseModal}>
      <div
        ...
        className=" transition transform duration-400 ease-out fixed flex flex-col w-full md:max-w-md h-5/6 bottom-0 right-0  md:top-1/2 md:left-1/2 rounded-xl border shadow-md bg-white md:-translate-x-1/2 md:-translate-y-1/2"
      >
